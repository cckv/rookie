//
//  KVNetWorkCacheTool.m
//
//  Created by OpenCom on 2015/11/23.
//  Copyright © 2015年 cckv. All rights reserved.
//

#import "KVNetWorkCacheTool.h"
...
@implementation KVNetWorkCacheTool
...
+(NSString *)cachePath
{
    ...
    NSString *path = [pathOfLibrary stringByAppendingPathComponent:@"KVNetworkCache"];
    return path;
}
