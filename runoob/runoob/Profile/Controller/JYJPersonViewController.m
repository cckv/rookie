...
- (void)setupUI {
    ...
    headerView.backgroundColor = [UIColor colorWithRed:245 / 255.0 green:247 / 255.0 blue:245 / 255.0 alpha:1.0];
    headerView.frame = CGRectMake(0, 0, 0, 150);
    self.tableView.tableHeaderView = headerView;
    
    /** 头像图片 */
    UIImageView *headerIcon = [[UIImageView alloc] init];
    headerIcon.image = [UIImage imageNamed:@"cainiao.jpg"];
...
- (void)setupData {
    JYJCommenItem *myWallet = [JYJCommenItem itemWithIcon:@"menu_wallet" title:@"我的概览" subtitle:@"" destVcClass:[JYJMyWalletViewController class]];
    
    JYJCommenItem *myCoupon = [JYJCommenItem itemWithIcon:@"menu_promo" title:@"我的收藏" subtitle:@"" destVcClass:[JYJMyCardViewController class]];
    ...
    self.data = @[myWallet, myCoupon, myFriend];
}
